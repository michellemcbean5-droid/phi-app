        ...
        <View style={styles.headerRow}>
          ...
          <TouchableOpacity onPress={() => setExplainerVisible(true)}>
            <Animated.View style={[styles.aiChip, { transform: [{ scale: pulseAnim }] }]}>
              <Text style={styles.aiChipText}>{aiPowered ? '🤖 AI Active' : '📋 How this works'}</Text>
            </Animated.View>
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalCard}>
            ...
            <ScrollView>
              ...
              <Text style={styles.modalParagraph}>
                On the Free plan, they need a free AI API key (Claude or Kimi, your choice) to reason like a real
                dispatcher (Settings {'>'} My API Keys, about 2 minutes to set up). Without one, they still work using
                simpler built-in logic — just less smart. Any paid plan skips this entirely — PHI runs the AI for you
                automatically.
              </Text>
              <Text style={styles.modalParagraph}>
