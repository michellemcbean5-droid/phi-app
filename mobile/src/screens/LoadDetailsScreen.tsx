...
const LOAD_DATA: Record<string, object> = {
  L001: { origin: 'Dallas, TX', destination: 'Atlanta, GA', miles: 781, rate: '$1,950', status: 'In Transit', weight: '42,000 lbs', commodity: 'Auto Parts', pickup: 'Jun 26 08:00', delivery: 'Jun 27 18:00', broker: 'Acme Freight', brokerPhone: '(555) 123-4567' },
  L002: { origin: 'Memphis, TN', destination: 'Chicago, IL', miles: 530, rate: '$1,320', status: 'Pending', weight: '38,000 lbs', commodity: 'Electronics', pickup: 'Jun 27 10:00', delivery: 'Jun 28 16:00', broker: 'FastLane Logistics', brokerPhone: '(555) 987-6543' },
  L003: { origin: 'Houston, TX', destination: 'Phoenix, AZ', miles: 1173, rate: '$2,800', status: 'Delivered', weight: '44,000 lbs', commodity: 'Building Materials', pickup: 'Jun 24 06:00', delivery: 'Jun 25 20:00', broker: 'SunBelt Freight', brokerPhone: '(555) 456-7890' },
};

export default function LoadDetailsScreen({ route }: Props) {
  const load = LOAD_DATA[route.params.loadId] as any;

  if (!load) return (
    <View style={styles.container}>
      <Text style={{ color: '#fff' }}>Load not found.</Text>
    </View>
  );
      ...
      <ScrollView contentContainerStyle={{ padding: 16 }}>
        {rows.map((r) => (
          <View key={r.label} style={styles.row}>
            <Ionicons name={r.icon as any} size={20} color="#e94560" style={{ width: 28 }} />
